...
<head>
    ...
    <link rel="stylesheet" href="/Digital-Mind/css/STYLE.css">
...
?>
            ...
            <div class="content-item">
                ...
                <div class="content-text">
                    ...
                    <a href="header.html" class="see-more">Ver más</a>
                </div>
            </div>

            <div class="content-item">
                <div class="content-image">
                    <img src="../images/img3.png" alt="Classroom">
                </div>
                <div class="content-text">
            ...
            <div class="content-item">
                <div class="content-image">
                    <img src="../images/escuela4.jpg" alt="Library">
                </div>
                <div class="content-text">
            ...
            <div class="content-item">
                ...
                <div class="content-text">
                    <div class="title">MÉTODO MONTESSORI</div>
                    <p>El método Montessori es un enfoque educativo centrado en el niño que se basa en la observación científica de su desarrollo natural. Este método fomenta la independencia, la libertad con límites y el respeto por el desarrollo físico, social y psicológico del niño. Los ambientes Montessori están diseñados para promover el autoaprendizaje y permiten a los niños aprender a su propio ritmo utilizando materiales especialmente diseñados que estimulan su curiosidad innata.</p>
                    <p class="published">Publicado hace 5 horas</p>
                    <a href="../PHP/Montessori_blog.html" class="see-more">Ver más</a>
                </div>
            </div>
    ...
    <footer class="page-footer">
        <div class="page-container">
            <div class="logo">
                <img src="../images/logo.png" alt="logo de DIGITALMIND">
            </div>
            <nav>
                <ul>
                    <li><a href="main_page.html">Inicio</a></li>
                    <li><a href="main_page.html">Categoría</a></li>
                    <li><a href="main_page.html">Contacto</a></li>
                </ul>
            </nav>
        </div>
    </footer>
