...
<div class="perfil-container">
    ...
    <div class="main-content">
        ...
        <div class="info-card" id="info">
            ...
            <div class="info-row">
                <div class="info-item"><strong>Nombre completo:</strong><br><?php echo htmlspecialchars($user['nombre']); ?></div>
                <div class="info-item"><strong>Correo electrónico:</strong><br><?php echo htmlspecialchars($user['email']); ?></div>
                <div class="info-item"><strong>Rol:</strong><br><?php echo ucfirst(htmlspecialchars($user['rol'] ?? 'usuario')); ?></div>
                <div class="info-item"><strong>Fecha de registro:</strong><br><?php echo htmlspecialchars($user['fecha_registro'] ?? ''); ?></div>
            </div>
        </div>
        ...
        <div class="section-list" id="articulos">
            ...
            <ul>
            <?php
            $sql_blogs = "SELECT * FROM publicaciones_2 WHERE usuario_id = '$usuario_id'";
